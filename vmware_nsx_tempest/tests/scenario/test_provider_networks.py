...
class ProviderNetworkScenario(feature_manager.FeatureManager):
    ...
    def test_provider_vxlan_network_scenario(self):
        ...
        self.check_cross_network_connectivity(
            ...
            self.servers_details["server1"].floating_ip,
            self.servers_details["server1"].server)
