...
class NSXPClient(object):
    ...
    def __set_url(self, api=None, secure=None, host=None, endpoint=None):
        ...
        self.url = '%s://%s/policy/api/%s/infra/%s' % (http_type, host, api, endpoint)
    ...
    def get_firewall_sections(self, tenant_id=None):
        ...
        """
        return self.get_logical_resources("domains/%s/security-policies" % tenant_id )
    ...
    def get_firewall_section_rules(self, fw_section, tenant_id=None):
        ...
        """
        endpoint = "domains/%s/security-policies/%s/rules" % (tenant_id ,fw_section['id'])
        return self.get_logical_resources(endpoint)

    def get_firewall_section_rule(self, fw_section, os_uuid, os_tenant_id=None):
        """
