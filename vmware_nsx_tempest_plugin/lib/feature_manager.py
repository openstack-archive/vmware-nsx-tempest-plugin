...
from vmware_nsx_tempest_plugin.services.octavia import octavia_listeners_client
from vmware_nsx_tempest_plugin.services.octavia import octavia_loadbalancer_client
from vmware_nsx_tempest_plugin.services.octavia import octavia_members_client
from vmware_nsx_tempest_plugin.services.octavia import octavia_pools_client
...
class FeatureManager(traffic_manager.IperfManager,
    ...
    def setup_clients(cls):
        ...
        cls.octavia_admin_client = octavia_loadbalancer_client.\
            get_client(cls.os_admin)
        cls.octavia_admin_listener_client = octavia_listeners_client.\
            get_client(cls.os_admin)
        cls.octavia_admin_pools_client = octavia_pools_client.\
            get_client(cls.os_admin)
        cls.octavia_admin_members_client = octavia_members_client.\
            get_client(cls.os_admin)
