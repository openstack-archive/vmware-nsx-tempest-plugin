...
class TestAllowedAddressPair(manager.NetworkScenarioTest):
    ...
    def _test_allowed_address_pair_on_vms_with_ipv4v6_ips(
        ...
        self._assign_ipv6_address(ssh_source, 'eth0:1', ipv6_address_vm1)
        self._assign_ip_address(ssh_source1, 'eth0:1', ipv4_address_vm2)
        self._assign_ipv6_address(ssh_source1, 'eth0:1', ipv6_address_vm2)
        self.assertTrue(self._check_remote_connectivity
    ...
    def _test_allowed_address_pair_on_vms_with_multiple_ipv4v6_ips(
        ...
        self._assign_ipv6_address(ssh_source, 'eth0:1', ipv6_address_vm1_1)
        self._assign_ip_address(ssh_source1, 'eth0:1', ipv4_address_vm2_1)
        self._assign_ipv6_address(ssh_source1, 'eth0:1', ipv6_address_vm2_1)
        self._assign_ip_address(ssh_source, 'eth0:2', ipv4_address_vm1_2)
        self._assign_ipv6_address(ssh_source, 'eth0:2', ipv6_address_vm1_2)
        self._assign_ip_address(ssh_source1, 'eth0:2', ipv4_address_vm2_2)
        self._assign_ipv6_address(ssh_source1, 'eth0:2', ipv6_address_vm2_2)
        self.assertTrue(self._check_remote_connectivity
